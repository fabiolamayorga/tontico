...
<script type="text/javascript" src="buscar_categoria.js"></script>
<title>Ejercicio con formularios</title>
</head>
<body onload="mostrarcategoria(<?php echo $id_categoria ?>);">
<table align="center">
<form action="" method="post" onkeydown="limpiar_campos();" id="Formulario">
<tr>
...
<tr>
  <td colspan="2" align="center">&nbsp;&nbsp;
    <input type="button" value="Buscar" name="Buscar" id="Buscar" onclick="mostrarcategoria(document.getElementById('Codigo').value,'M');" /><input type="submit" value="Actualizar" name="Actualizar" id="Actualizar"/><input type="button" value="Cancelar" name="Cancelar" id="Cancelar" onclick="cancelar;"/> 
</tr>
<tr>
